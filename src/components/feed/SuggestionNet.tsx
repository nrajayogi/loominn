...
const SUGGESTIONS = [
    { id: 1, name: "Elena R.", role: "AI Researcher", company: "DeepMind", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80", relevance: "98%" },
    { id: 2, name: "James K.", role: "Product Design", company: "Airbnb", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80", relevance: "94%" },
    { id: 3, name: "Sofia L.", role: "Frontend Dev", company: "Vercel", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80", relevance: "89%" },
    { id: 4, name: "Marcus T.", role: "CTO", company: "StartUp", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80", relevance: "85%" },
];
        ...
        <div className="w-full bg-zinc-900/30 border border-white/5 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-zinc-500 text-xs mt-1">Found 4 professionals in your resonance field.</p>
                </div>
                ...
                {SUGGESTIONS.map((user) => (
                    ...
                    >
                        <div className="relative mb-3">
                            ...
                            <div className="absolute -bottom-1 -right-1 bg-zinc-900 text-[10px] font-bold text-green-400 px-1.5 py-0.5 rounded-full border border-zinc-800 shadow-sm">
                                {user.relevance}
                            </div>
                        </div>
