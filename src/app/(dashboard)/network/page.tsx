...
import { UserPlus, Search, MoreHorizontal, UserCheck, Briefcase } from "lucide-react";
        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-zinc-400">Manage your connections and pending requests.</p>
                </div>
            ...
            <div className="flex border-b border-white/10">
                <button
                    ...
                    className={`px-6 py-3 font-medium transition-colors relative ${activeTab === "connections" ? "text-white" : "text-zinc-500 hover:text-zinc-300"}`}
                >
                    Connections (154)
                    {activeTab === "connections" && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500"></div>}
                </button>
                <button
                ...
                {activeTab === "connections" ? (
                    ...
                    [1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="bg-zinc-900/50 border border-white/5 rounded-2xl p-4 flex items-center gap-4 group hover:border-white/10 transition-colors">
                            ...
                            <button className="p-2 hover:bg-blue-600/20 rounded-lg text-blue-500 hover:text-blue-400 transition-colors">
                                <UserCheck size={20} />
                            </button>
                        </div>
                    ))
                        ...
                        <div key={i} className="bg-zinc-900/50 border border-white/5 rounded-2xl p-6 flex flex-col gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-600 mt-1">24 Mutual Connections</p>
                                </div>
                            </div>
